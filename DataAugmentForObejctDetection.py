...
if __name__ == '__main__':
    ...
    destination_pic_root_path = './Crop_Images'
    destination_xml_root_path = './Crop_Annotations'

    if not os.path.exists(destination_pic_root_path):
        os.makedirs(destination_pic_root_path)

    if not os.path.exists(destination_xml_root_path):
        os.makedirs(destination_xml_root_path)
    ...
    for parent, _, files in os.walk(source_pic_root_path):
        for file in files:
            ...
            generate_xml(file,auged_bboxes,auged_img.shape,destination_xml_root_path)
            cv2.imwrite(f'{destination_pic_root_path}/{file}',auged_img)
